...
public class RTPExport implements ControllerListener, DataSinkListener {
    ...
    public RTPExport(String _outputURL, Integer _duration, String session) {
    	
    	this.outputURL = _outputURL;
    	this.duration = _duration;
    	
    	String inputURL = "rtp://" + session;
    	
    	
    	this.iml = createMediaLocator(inputURL);
    	this.oml = createMediaLocator(inputURL);
    ...
    public RTPExport(String _outputURL, Integer _duration, String[] _sessions) {
		...
		for (int i=0 ; i< _sessions.length ; i++) {
			...
			if (i==0) {
				...
				inputURL = "rtp://" + _sessions[0];
			}
			else {
				
				inputURL = inputURL + "&" + _sessions[i];
			}
        }
